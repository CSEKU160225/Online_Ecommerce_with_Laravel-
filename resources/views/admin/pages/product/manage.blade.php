...
<table class="table table-hover table-striped">
	...
	<tr>
			<th>#</th>
		<th>{{$pro->title}} in {{$pro->Category}}</th>
		<th>{{$pro->price}}</th>
		<th>{{$pro->quantity}}</th>
		<th><a href="{{route('admin.product.edit',$pro->id)}}" class="btn btn-success">Edit</a>
		<a href="{{route('admin.product.distroy',$pro->id)}}" class="btn btn-danger">Delete</a>
		</th>
		</tr>
	@endforeach
