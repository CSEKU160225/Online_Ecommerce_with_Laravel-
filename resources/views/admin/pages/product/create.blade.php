          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="{{route('admin.category.manage')}}">
                <i class="menu-icon typcn typcn-bell"></i>
                <span class="menu-title">See  Category</span>
              </a>
            </li>
              </div>
            </li>
...
@endif
  ...
  <div class="form-group">
   ...
   <textarea name="des" rows="8" cols="30"></textarea>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control"  name="quan" placeholder="Enter Quantity">
