...
@endif
  ...
  <div class="form-group">
    ...
    <input type="text"  value="{{$product->title}}" class="form-control"  name="title" placeholder="Enter Title">
    
  </div>
  <div class="form-group">
    <label for="">Description</label>
   <textarea name="des" rows="8" value="{{$product->description}}" cols="30"></textarea>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control" value="{{$product->quantity}}" name="quan" placeholder="Enter Quantity">
    
  </div>

  <div class="form-group">
    <label for="">Product Image</label>
    <input type="file" class="form-control"  name="pimage" placeholder="Enter Quantity">
